...
M.APP_MODAL_KEYS_IN_ORDER = {
  ...
  "nametableBreakpointCalculatorModal",
}
...
M.MODAL_WHEEL_HANDLER_KEYS = {
  ...
  ppuFrameRangeModal = true,
  romPaletteAddressModal = true,
  galleryRomConfirmModal = true,
}
...
M.APP_MODAL_TEXTINPUT_ROUTES = {
  ...
  { key = "nametableBreakpointCalculatorModal", method = "textinput" },
}
