-- core_controller_window_content_draw.lua
-- Window tile/layer content, drop shadows, and workspace window drawing.
...
function AppCoreController:drawAllWindowShadows()
  drawAllWindowShadows(self)
end

function AppCoreController:drawAllModalShadows()
  drawAllModalShadows(self)
end

function AppCoreController:drawWindows()
  drawWindows(self)
end

function AppCoreController:getActiveGlobalPaletteBgColor(wm)
  return getActiveGlobalPaletteBgColor(wm)
end

function AppCoreController:getRomPaletteBgColorForWindow(win, wm)
  return getRomPaletteBgColorForWindow(win, wm)
end

function AppCoreController:getPaletteFromAttrBytes(attrBytes, cols, tileCol, tileRow)
  return getPaletteFromAttrBytes(attrBytes, cols, tileCol, tileRow)
end

function AppCoreController:isAnimationKind(win)
  return isAnimationKind(win)
end
