...
local SCENARIO_ALIASES = {
  ...
  rom_palette_links_demo = "rom_palette_link_consequences",
  rom_palette_link_interactions_demo = "rom_palette_link_consequences",
  rom_palette_link_consequences_demo = "rom_palette_link_consequences",
  pattern_table_link_interactions_demo = "pattern_table_link_consequences",
  pattern_table_link_consequences_demo = "pattern_table_link_consequences",
  minimize_other_not_linked_demo = "minimize_other_not_linked",
  taskbar_minimize_restore_demo = "taskbar_minimize_restore",
  ...
  rom_palette_hex_grid_flow_demo = "rom_palette_hex_grid_flow",
  oam_sprite_hex_grid_flow_demo = "oam_sprite_hex_grid_flow",
  nametable_hex_grid_flow_demo = "nametable_hex_grid_flow",
