...
local NewWindowTypeModal = require("ui.modals.new_window_type_modal")
local NewWindowModal = require("ui.modals.new_window_modal")
local OpenProjectModal = require("ui.modals.open_project_modal")
local PPUFrameAddSpriteModal = require("ui.modals.ppu_frame_add_sprite_modal")
...
local PPUFramePatternRangeModal = require("ui.modals.ppu_frame_pattern_range_modal")
...
local TextFieldDemoModal = require("ui.modals.text_field_demo_modal")
...
local GalleryRomResultModal = require("ui.modals.gallery_rom_result_modal")
local RomPaletteRoleModal = require("ui.modals.rom_palette_role_modal")
...
function AppCoreController.new()
  ...
  self.swapTwoColorsModal = SwapTwoColorsModal.new()
