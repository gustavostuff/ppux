...
merge(scenarios, require("test.e2e_visible.scenarios.builders.rom_palette_link_consequences"))
merge(scenarios, require("test.e2e_visible.scenarios.builders.pattern_table_link_consequences"))
