...
describe("sketch_canvas_gallery_rom_controller.lua", function()
  ...
  it("writes slide assets and meta without make", function()
    ...
    metaFh:close()
    expect(meta:find("slide_count:", 1, true)).toBeTruthy()
    expect(meta:find("fade_hold:", 1, true)).toBeTruthy()
    expect(meta:find("use_transitions:", 1, true)).toBeTruthy()
    expect(meta:find("show_first_once:", 1, true)).toBeTruthy()
    expect(meta:find("%.byte 1", 1, false)).toBeTruthy()
    expect(meta:find("%.byte 6", 1, false)).toBeTruthy()
