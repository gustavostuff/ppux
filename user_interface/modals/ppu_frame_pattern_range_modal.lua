...
function Dialog:draw(canvas)
  ...
  -- Do not rebuild the Panel every frame: each rebuild creates a new Panel and drops `pressedButton`
  -- captured on mouse pressed, so mousereleased never matches Add/Cancel to fire their actions.
