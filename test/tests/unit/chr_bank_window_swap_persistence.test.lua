...
describe("chr_bank_window.lua - constructor", function()
  it("initializes CHR-specific defaults and flags", function()
    ...
    expect(win.titleLocked).toBe(true)
    expect(win.title).toBe("Bank 1/1")
