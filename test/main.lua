...
loadTestFile("tests/unit/sketch_canvas_phase1.test")
loadTestFile("tests/unit/sketch_canvas_phase2.test")
loadTestFile("tests/unit/sketch_canvas_phase3.test")
loadTestFile("tests/unit/sketch_canvas_phase4.test")
loadTestFile("tests/unit/sketch_canvas_phase5.test")
loadTestFile("tests/unit/sketch_canvas_phase6.test")
loadTestFile("tests/unit/sketch_canvas_phase7.test")
