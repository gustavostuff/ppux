...
set "SCENARIOS=default_action_delay modals boot_and_drag animation_playback grid_resize_toolbar tile_edit_roundtrip brush_paint_tools new_window_variants palette_shader_preview static_sprite_ops undo_redo_events palette_edit_roundtrip rom_palette_link_interactions save_reload_persistence submenu_positions context_menus_and_submenus window_resize_and_hover_priority toolbar_auto_placement_drag modal_navigation_keyboard_only text_field_variants clipboard_matrix ppu_toolbar_ranges_setup ppu_toolbar_pattern_ranges ppu_toolbar_sprite_and_mode_controls open_project_happy_path open_project_invalid_file oam_animation_workflow"
