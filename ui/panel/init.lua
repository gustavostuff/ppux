...
local Cells = require("ui.panel.cells")
local Layout = require("ui.panel.layout")
local Input = require("ui.panel.input")
local Rendering = require("ui.panel.rendering")
...
local function createButtonForCell(panel, cell)
  return Button.new({
    ...
    iconTintColor = cell.iconTintColor,
    ...
    skipHoverFocusUnderlay = cell.skipHoverFocusUnderlay == true,
  })
end
