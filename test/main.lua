...
loadTestFile("tests/unit/love_compat.test")
loadTestFile("tests/unit/filesystem_path.test")
loadTestFile("tests/unit/nametable_utils.test")
loadTestFile("tests/unit/konami_nt_scanner.test")
loadTestFile("tests/unit/oam_heuristic_scanner.test")
loadTestFile("tests/unit/zelda2_codec.test")
loadTestFile("tests/unit/pattern_table_display_controller.test")
loadTestFile("tests/unit/pattern_table_mapping.test")
loadTestFile("tests/unit/ppu_frame_range_helpers_pattern_chr.test")
loadTestFile("tests/unit/shader_palette_controller.test")
loadTestFile("tests/unit/nametable_tiles_controller.test")
loadTestFile("tests/unit/nametable_on_the_fly_replacements.test")
loadTestFile("tests/unit/nametable_unscramble_controller_undo.test")
loadTestFile("tests/unit/nametable_unscramble_controller_spacing.test")
loadTestFile("tests/unit/nametable_unscramble_controller_pattern_table.test")
...
loadTestFile("tests/unit/window_capabilities.test")
  ...
  loadTestFile("tests/unit/grid_overlay_metrics.test")
  loadTestFile("tests/unit/grid_mode_utils.test")
...
loadTestFile("tests/unit/swap_two_colors.test")
loadTestFile("tests/unit/chr_group_drag_drop.test")
loadTestFile("tests/unit/mirror_x_drop_group_offsets.test")
loadTestFile("tests/unit/mirror_x_drop_hover_bounds.test")
loadTestFile("tests/unit/mirror_x_drop_placement.test")
loadTestFile("tests/unit/mirror_x_clipboard_paste.test")
...
loadTestFile("tests/unit/panel_modal_utils_right_drag.test")
loadTestFile("tests/unit/contextual_menu_controller.test")
loadTestFile("tests/unit/dropdown.test")
...
loadTestFile("tests/unit/core_controller_shared_modal_routing.test")
loadTestFile("tests/unit/core_controller_settings_apply.test")
loadTestFile("tests/unit/settings_modal_fields.test")
loadTestFile("tests/unit/undo_redo_command_registry.test")
...
loadTestFile("tests/unit/palette_link_render_controller.test")
loadTestFile("tests/unit/window_link_visual_controller.test")
loadTestFile("tests/unit/window_link_badge_controller.test")
loadTestFile("tests/unit/toolbar_base_button_release.test")
loadTestFile("tests/unit/header_toolbar_expand.test")
...
loadTestFile("tests/unit/relocation_pointer_math.test")
loadTestFile("tests/unit/relocation_pointer_calculator_modal.test")
loadTestFile("tests/unit/nametable_breakpoint_math.test")
loadTestFile("tests/unit/nametable_breakpoint_calculator_modal.test")
...
loadTestFile("tests/unit/save_project_folder_modal.test")
...
loadTestFile("tests/unit/generic_actions_modal.test")
loadTestFile("tests/unit/ppu_frame_sprite_layer_mode_modal.test")
loadTestFile("tests/unit/ppu_frame_add_sprite_modal_initial_values.test")
loadTestFile("tests/unit/ppu_frame_add_sprite_modal_sync.test")
loadTestFile("tests/unit/ppu_frame_add_sprite_modal_scan.test")
loadTestFile("tests/unit/ppu_frame_range_modal.test")
loadTestFile("tests/unit/nametable_shape_preview.test")
loadTestFile("tests/unit/pattern_layer_gate.test")
loadTestFile("tests/unit/rom_hex_grid.test")
loadTestFile("tests/unit/oam_sprite_preview.test")
...
loadTestFile("tests/unit/chr_diff_overlay.test")
loadTestFile("tests/unit/chr_bank_ui_helpers.test")
loadTestFile("tests/unit/bank_canvas_controller.test")
...
loadTestFile("tests/unit/rom_project_controller_save_paths.test")
loadTestFile("tests/unit/tile_invalidation_index.test")
...
loadTestFile("tests/e2e/open_project_flow.test")
loadTestFile("tests/e2e/oam_animation_workflow.test")
loadTestFile("tests/e2e/rom_hex_grid_flows.test")
loadTestFile("tests/e2e/mirror_x_chr_group_drop.test")
loadTestFile("tests/e2e/pattern_table_link_consequences.test")
loadTestFile("tests/e2e/rom_palette_link_consequences.test")
...
loadTestFile("tests/unit/sprite_hydration_pattern_table.test")
loadTestFile("tests/unit/oam_displacement.test")
...
loadTestFile("tests/unit/image_import_pattern_table.test")
...
loadTestFile("tests/unit/window_link_visibility_handle_hit_test.test")
loadTestFile("tests/unit/window_link_visibility_focus.test")
...
loadTestFile("tests/unit/oam_animation_window.test")
...
loadTestFile("tests/unit/window_factory_controller.test")
...
loadTestFile("tests/unit/mouse_tile_drop_sketch_undo.test")
...
loadTestFile("tests/unit/ppu_frame_window_nametable_peer_sync.test")
loadTestFile("tests/unit/ppu_frame_range_undo_peer_sync.test")
loadTestFile("tests/unit/ppu_frame_nametable_helpers.test")
loadTestFile("tests/unit/sketch_canvas_window.test")
loadTestFile("tests/unit/sketch_canvas_window_creation.test")
loadTestFile("tests/unit/sketch_canvas_persistence.test")
loadTestFile("tests/unit/sketch_canvas_pack_controller.test")
loadTestFile("tests/unit/sketch_canvas_png_import.test")
loadTestFile("tests/unit/ppux_sketch_native.test")
loadTestFile("tests/unit/sketch_canvas_pattern_table_link.test")
loadTestFile("tests/unit/sketch_canvas_tolerance_chr_lock.test")
loadTestFile("tests/unit/sketch_canvas_reflect_view.test")
loadTestFile("tests/unit/sketch_canvas_tile_clipboard.test")
loadTestFile("tests/unit/sketch_canvas_pt_chr_pixel_copy.test")
loadTestFile("tests/unit/sketch_canvas_export_controller.test")
loadTestFile("tests/unit/gallery_slide_thumb_strip.test")
loadTestFile("tests/unit/sketch_canvas_palette_link.test")
loadTestFile("tests/unit/sketch_canvas_display_controller.test")
loadTestFile("tests/unit/sketch_canvas_pixel_selection.test")
loadTestFile("tests/unit/palette_activation_controller.test")
loadTestFile("tests/unit/palette_window.test")
loadTestFile("tests/unit/palette_edit_helpers.test")
